 ...
 */
router.get("/", (req, res) => {
  res.status(200).json([{ id: 1, name: "Azienda XYZ" }]);
});
 ...
 */
router.post("/", (req, res) => {
  res.status(201).json({ message: "Azienda creata" });
});
...
router.put("/:id", (req, res) => {
  res.status(200).json({ message: "Azienda aggiornata" });
});
...
router.delete("/:id", (req, res) => {
  res.status(200).json({ message: "Azienda eliminata" });
});
